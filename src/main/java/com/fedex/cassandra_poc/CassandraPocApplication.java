package com.fedex.cassandra_poc;
...
public class CassandraPocApplication {
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(CassandraPocApplication.class);
	...
	public static void main(String[] args) throws NoSuchAlgorithmException {
		...
		CqlSession cqlSession = new ApplicationConfig().session();
